# CLAUDE.md (archived — production stabilization ruleset)

> **Archived 2026-06-01.** This is the strict, production-grade ruleset that governed
> lord-kali before the TUI approval gate work (`docs/plans/tui-approval-gate.md`). It is
> paused during active construction because several rules — notably "no fallback
> mechanisms" and "no unnecessary complexity / new files" — conflict with deliberate
> construction decisions (graceful degradation, new dependencies, planning artifacts).
> The live, construction-phase guidance is in the repository-root `CLAUDE.md`. Re-adopt
> the principles below as the bar for stabilization once the feature lands.
